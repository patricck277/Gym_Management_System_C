...
namespace Firma.ViewModels
{
    public class RaportSprzedazyViewModel:WorkspaceViewModel
    {
        ...
        public IQueryable<KeyAndValue> PassComboBoxItems        {
            get
            {
                return new TowarB(gymEntities).GetPassKeyAndValueItems();
            }
        }
        ...
        {
            Utarg = new UtargB(gymEntities).UtargPassOkres(IdKarnety, DataOd, DataDo);
        }
